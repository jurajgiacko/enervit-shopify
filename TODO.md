# Enervit Shopify – TODO

> Edituj na mobile cez GitHub app. Checkuj tasky priebežne.
...
- [ ] SK jazyková mutácia (enervit.sk / enervitsport.sk)
- [ ] Affiliate program — Dognet vs. Weave Network
- [ ] Emailing — Ecomail vs. Klaviyo
- [ ] Heureka prepojenie
- [ ] 301 redirecty zo starého e-shopu
- [ ] Obsahový web zlúčiť s e-shopom (enervit.cz = e-shop)
- [ ] UGC obsah na produktových kartách
- [ ] Recenzie

## 🔵 CEE expanzia (horizont ~6 mesiacov)

- [ ] Bulharsko — lokalizácia, cenník
- [ ] Rumunsko — lokalizácia, cenník
- [ ] Maďarsko — lokalizácia, cenník

## ✅ Hotové

- [x] Rozhodnutie: Royal Bay = separátny e-shop (17.2.)
- [x] Obsahový web enervit.cz sa ruší → e-shop priamo na doméne
- [x] Zrušenie partnerských predajní (osobný odber)
- [x] Zrušenie ISIC zľavy
