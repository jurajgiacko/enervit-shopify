...
## Cross-sell mapa (podľa reálnych produktov)

### Tréningový flow (hlavný cross-sell princíp)

```
PŘED                    →    BĚHEM                →    PO
PRE Sport                    Carbo Gel C2:1            After Sport Drink R1
Carbo Flow                   Isotonic Drink            R2 Recovery Drink
Competition Bar              Electrolytes Boost        Magic Cherry
                              Salt Caps
                                    ↓
                              MEZI TRÉNINKY
                              Whey Protein
...
### Konkrétne cross-sell páry

| Ak kupuje | Ponúkni k tomu |
|---|---|
| Carbo Gel C2:1 | Isocarb C2:1, Carbo Bar C2:1, C2:1 láhev |
| Enervit Gel | Isotonic Drink, Competition Bar, Enervit láhev |
| Isotonic Drink | Gel, Salt Caps, Magnesium Sport |
| PRE Sport | Gel (na tréning), R2 Recovery (po) |
| Whey Protein | BCAA, Creatine, Protein Bar |
| After Sport Drink | R2 Recovery, Magic Cherry |

### Upsell (Enervit → C2:1 PRO)

| Z (Enervit) | Na (C2:1 PRO) | Prečo |
|---|---|---|
| Enervit Gel | Carbo Gel C2:1 | 2:1 pomer, rýchlejšia absorpcia |
| Isotonic Drink | Isocarb C2:1 | Vyšší obsah sacharidov |
| Competition Bar | Carbo Bar C2:1 | Pro-level energia |
| 1ks gél/tyčinka | 24ks krabička | Lepšia cena za kus |
| Mix príchutí | Celá řada C2:1 (sada) | Kompletný závodní set |
